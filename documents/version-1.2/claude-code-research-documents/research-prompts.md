...
**用途**：每个 `---PROMPT START---` 到 `---PROMPT END---` 之间的内容是一份完整的 ultraplan 提示词，直接复制粘贴给 ultraplan 即可。

**调研报告输出目录**：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/`

---

## 共同背景（每份提示词里都包含了，无需单独看）
...
---PROMPT START--- 01 / Agent 核心循环 / ReAct Pipeline
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/01-agent-loop.md`
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（已有对标分析）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/app/chat/runner.go`（Forgify 现有实现）

---PROMPT END---


---PROMPT START--- 02 / 工具完整度（Tool 系统）
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/02-tools.md`
- 细致到代码级别
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§B 工具系统）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/app/agent/tool.go`

---PROMPT END---


---PROMPT START--- 03 / Context 管理 / Compaction
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/03-context.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§C Context 管理）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/app/chat/history.go`

---PROMPT END---


---PROMPT START--- 04 / 记忆系统
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/04-memory.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§D 记忆系统）

---PROMPT END---


---PROMPT START--- 05 / Subagent 系统
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/05-subagent.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§E Subagent 系统）

---PROMPT END---


---PROMPT START--- 06 / Hooks 系统
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/06-hooks.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§G Hooks 系统）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/app/chat/tools.go`（现有 executeTool）

---PROMPT END---


---PROMPT START--- 07 / 用户体验工具（AskUserQuestion / Task 系统）
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/07-ux-tools.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§I 用户体验工具）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/domain/events/types.go`（现有 SSE 事件）

---PROMPT END---


---PROMPT START--- 08 / 权限与安全系统
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/08-permissions.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§F 权限与安全系统）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/app/agent/system.go`（现有 system tools）

---PROMPT END---


---PROMPT START--- 09 / MCP 集成
...
## 输出要求
- 语言：**中文**
- 保存到：`/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/claude-code-research-documents/09-mcp.md`
- 细致到代码级别
- 找不到的细节明确标注"未在泄漏源码分析中找到"
...
可参考：
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/documents/version-1.2/agent-core-upgrade.md`（§H MCP 集成）
- `/Users/sunweilin/Documents/Personal-Codebase/Forgify/backend/internal/app/agent/tool.go`（现有 Tool 接口）
